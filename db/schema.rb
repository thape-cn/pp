...
ActiveRecord::Schema[8.1].define(version: 2025_06_30_080206) do
  ...
  create_table "corp_president_managed_companies", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
  ...
  create_table "ended_company_evaluation_role_capabilities", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "import_excel_file_messages", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.bigint "import_excel_file_id", null: false
    t.string "message"
  ...
  create_table "import_excel_files", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "company_evaluation_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "secretary_managed_departments", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "managed_dept_code"
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false

...
json.evaluation_user_capability do
  ...
  json.manager_overall_output_hint @company_evaluation_template.manager_overall_output_hint
  json.manager_overall_improvement markdown(@evaluation_user_capability.manager_overall_improvement)
  json.manager_overall_improvement_hint @company_evaluation_template.manager_overall_improvement_hint
  json.manager_overall_plan markdown(@evaluation_user_capability.manager_overall_plan)
  json.manager_overall_plan_hint @company_evaluation_template.manager_overall_plan_hint

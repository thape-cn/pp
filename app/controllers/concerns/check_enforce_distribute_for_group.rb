module CheckEnforceDistributeForGroup
  ...
  def check_enforce_distribute_for_manager_group(calibration, enforce_highest_only)
    ...
    if enforce_highest_only
      if lower_quotas_manager[:beyond_standard_rate] >= beyond_standard_rate_people_count
        nil
      else

module Staff
  class CalibrationSessionsController < BaseController
    ...
    def update_staff_group(calibration)
      update_staff_by_square(calibration["11"]) { |euc| euc.update(calibration_work_load: 5, calibration_work_quality: 1, calibration_work_attitude: euc.work_attitude) }
      update_staff_by_square(calibration["12"]) { |euc| euc.update(calibration_work_load: 5, calibration_work_quality: 3, calibration_work_attitude: euc.work_attitude) }
      update_staff_by_square(calibration["13"]) { |euc| euc.update(calibration_work_load: 5, calibration_work_quality: 5, calibration_work_attitude: euc.work_attitude) }
      update_staff_by_square(calibration["21"]) { |euc| euc.update(calibration_work_load: 3, calibration_work_quality: 1, calibration_work_attitude: euc.work_attitude) }
      update_staff_by_square(calibration["22"]) { |euc| euc.update(calibration_work_load: 3, calibration_work_quality: 3, calibration_work_attitude: euc.work_attitude) }
      update_staff_by_square(calibration["23"]) { |euc| euc.update(calibration_work_load: 3, calibration_work_quality: 5, calibration_work_attitude: euc.work_attitude) }
      update_staff_by_square(calibration["31"]) { |euc| euc.update(calibration_work_load: 1, calibration_work_quality: 1, calibration_work_attitude: euc.work_attitude) }
      update_staff_by_square(calibration["32"]) { |euc| euc.update(calibration_work_load: 1, calibration_work_quality: 3, calibration_work_attitude: euc.work_attitude) }
      update_staff_by_square(calibration["33"]) { |euc| euc.update(calibration_work_load: 1, calibration_work_quality: 5, calibration_work_attitude: euc.work_attitude) }
    end
    ...
    def update_manager_group(calibration)
      update_staff_by_square(calibration["11"]) { |euc| euc.update(calibration_management_profession_score: 1, calibration_performance_score: 5) }
      update_staff_by_square(calibration["12"]) { |euc| euc.update(calibration_management_profession_score: 3, calibration_performance_score: 5) }
      update_staff_by_square(calibration["13"]) { |euc| euc.update(calibration_management_profession_score: 5, calibration_performance_score: 5) }
      update_staff_by_square(calibration["21"]) { |euc| euc.update(calibration_management_profession_score: 1, calibration_performance_score: 3) }
      update_staff_by_square(calibration["22"]) { |euc| euc.update(calibration_management_profession_score: 3, calibration_performance_score: 3) }
      update_staff_by_square(calibration["23"]) { |euc| euc.update(calibration_management_profession_score: 5, calibration_performance_score: 3) }
      update_staff_by_square(calibration["31"]) { |euc| euc.update(calibration_management_profession_score: 1, calibration_performance_score: 1) }
      update_staff_by_square(calibration["32"]) { |euc| euc.update(calibration_management_profession_score: 3, calibration_performance_score: 1) }
      update_staff_by_square(calibration["33"]) { |euc| euc.update(calibration_management_profession_score: 5, calibration_performance_score: 1) }
    end

    def update_staff_by_square(calibration_square)

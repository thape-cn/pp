namespace :activate do
  ...
  desc "Create the EvaluationUserCapability"
  task :evaluation_user, [:company_evaluation_id, :excel_file] => [:environment] do |task, args|
    ...
    Initiation.new_evaluation(company_evaluation, excel_file_path)
  end
